...
<section class="iphoneMock">
  <div class="container">
    ...
    <div class="interactionInfo hidden">
      ...
      margin-left: 16px;">iPhone 12. iOS 14</h1>
      <img src="https://i.postimg.cc/SxYDvrKB/IMG-2584.jpg" style="height: auto;
      width: 70%;" >
      <div>
        <a target="_blank" href="https://www.youtube.com/channel/UCzB2vC0kH-PPbrGmqeII9hQ" class="fa fa-youtube"></a> 
        <a target="_blank" href="https://www.instagram.com/developer_rahul_" class="fa fa-instagram"></a>
        <a target="_blank"  href="https://www.facebook.com/rahul.sahni.169" class="fa fa-facebook"></a>
        <a target="_blank"  href="https://twitter.com/rahulsahni_169" class="fa fa-twitter"></a>
      </div>
